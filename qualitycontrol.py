...
INPUT_DIR = r"C:\Users\mvtha\Downloads\test2"

# Thư mục lưu ảnh sau tiền xử lý + ảnh bị loại + report
OUTPUT_DIR = r"C:\Users\mvtha\Downloads\test2_preprocessed"

# File threshold JSON bạn đã calibrate từ tập train/reference
THRESHOLD_JSON = r"C:\Users\mvtha\Downloads\empirical_qc_thresholds.json"
